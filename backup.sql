...
--
-- Name: dify; Type: DATABASE; Schema: -; Owner: dify
--

CREATE DATABASE dify WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';
...
ALTER TABLE public.invitation_codes_id_seq OWNER TO dify;
...
--
-- Name: system_variables; Type: TABLE; Schema: public; Owner: dify
--
...
ALTER TABLE public.system_variables OWNER TO dify;
...
CREATE TABLE public.tenants (
    ...
    updated_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP(0) NOT NULL,
    custom_config text,
    name character varying(255) DEFAULT 'Default Workspace'::character varying NOT NULL,
...
COPY public.message_annotations (id, app_id, conversation_id, message_id, content, from_source, from_account_id, created_at, updated_at, question, hit_count) FROM stdin;
\.
...
COPY public.messages (id, app_id, model_provider, model_id, override_model_configs, conversation_id, inputs, query, message, message_tokens, message_unit_price, message_price_unit, answer, answer_tokens, answer_unit_price, answer_price_unit, parent_message_id, provider_response_latency, total_price, currency, status, error, message_metadata, invoke_from, from_source, from_end_user_id, from_account_id, created_at, updated_at, agent_based, workflow_run_id) FROM stdin;
\.
...
--
-- Data for Name: system_variables; Type: TABLE DATA; Schema: public; Owner: dify
--

COPY public.system_variables (id, tenant_id, variables, created_at, updated_at) FROM stdin;
\.
...
COPY public.upload_files (id, tenant_id, type, key, name, size, extension, created_by, created_at, created_by_role, source_url) FROM stdin;
\.
...
--
-- Name: system_variables pk_system_variables; Type: CONSTRAINT; Schema: public; Owner: dify
--

ALTER TABLE ONLY public.system_variables
    ADD CONSTRAINT pk_system_variables PRIMARY KEY (id);
...
--
-- Name: tenant_account_join_account_idx; Type: INDEX; Schema: public; Owner: dify
--

CREATE INDEX tenant_account_join_account_idx ON public.tenant_account_joins USING btree (account_id);


--
-- Name: tenant_account_join_tenant_idx; Type: INDEX; Schema: public; Owner: dify
--

CREATE INDEX tenant_account_join_tenant_idx ON public.tenant_account_joins USING btree (tenant_id);
...
--
-- Name: workflow_node_execution_workflow_run_idx; Type: INDEX; Schema: public; Owner: dify
--
...
--
-- Name: dify_plugin; Type: DATABASE; Schema: -; Owner: dify
--
